 ...
 * return: mpls_return_enum
 */
extern mpls_return_enum mpls_socket_multicast_if_tx(const mpls_socket_mgr_handle handle, mpls_socket_handle socket, const mpls_if_handle iface);

/*
 * in: handle, socket, iff, mult
 * return: mpls_return_enum
 */
extern mpls_return_enum mpls_socket_multicast_if_join(const mpls_socket_mgr_handle handle, mpls_socket_handle socket, const mpls_if_handle iface,
	const mpls_inet_addr * mult);

/*
 * in: handle, socket, iff, mult
 */
extern void mpls_socket_multicast_if_drop(const mpls_socket_mgr_handle handle, mpls_socket_handle socket, const mpls_if_handle iface,
	const mpls_inet_addr * mult);
