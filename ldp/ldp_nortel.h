...
#define MPLS_PWID_FEC           0x80 /* pw id fec element           */
...
typedef struct mplsLdpPWIDFec_s {
  u_char type;
  u_char has_control_word:1;
  u_short pw_type:15;
  u_char pw_length;
  u_int group_id;
  u_int pw_id;
...
typedef union mplsFecElement_u {
  ...
  struct mplsLdpPWIDFec_s pwidEl; /* PW ID fec elem */
